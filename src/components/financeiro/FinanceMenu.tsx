// src/components/finance/FinanceMenu.tsx
"use client";
...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Contas a pagar (lançamento)", href: "/financeiro/contas-a-pagar" },
      { label: "Contas a receber (lançamento)", href: "/financeiro/contas-a-receber" },
    ],
  },
  {
    title: "Cadastros",
...
// helper para “opt-out” dos typed routes quando a rota ainda não existe no type
