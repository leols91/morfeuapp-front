...
// Estrutura de seções (como no menu de acomodações)
...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Categorias de Produtos", href: "/estoque/categorias" },
      { label: "Categorias de Despesas", href: "/estoque/categorias" },
    ],
  },
];

// helper para tipar rotas (igual ao usado no menu de acomodações)
                    ...
                    <li key={it.href}>
                      <Link
                        ...
                        className={cn(
                          ...
                          active && "bg-black/5 dark:bg-white/5 font-medium"
                        )}
